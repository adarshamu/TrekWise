    ...
    <div style={styles.pageWrapper} className="auth-page">
      ...
      <div style={styles.card} className="auth-card">
        ...
        <div style={styles.rightPanel} className="auth-right-panel auth-scroll">
          ...
          {/* Welcome to TrekWise — hero block (login has room to breathe) */}
          <div style={styles.welcomeWrap}>
            <div className="welcome-svg" style={styles.welcomeIcon}>
              <svg width="52" height="52" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" style={{ filter: "drop-shadow(0 2px 8px rgba(0,0,0,0.35))" }}>
            ...
            <div style={styles.welcomeTitle}>Welcome to TrekWise</div>
            <div style={styles.welcomeSub}>Your adventure starts here</div>
          </div>
          ...
          <div style={styles.inputGroup}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={styles.eyeContainer} onClick={() => setShowPassword(!showPassword)}>
                {showPassword ? (
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.85)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const styles = {
  ...
  forgotPass: { textAlign: "center", marginTop: "20px" },
  link: {
    color:          "rgba(255,255,255,0.9)",
    textDecoration: "none",
    fontWeight:     "700",
